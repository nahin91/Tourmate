...
import com.tbz.practice.tourmateexample1.Fragments.RegistrationFragment;
import com.tbz.practice.tourmateexample1.Map.MapsActivity;
import com.tbz.practice.tourmateexample1.NearBy.NearByActivity;
import com.tbz.practice.tourmateexample1.Weather.MainActivityWeather;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ft.add(R.id.eventFragmentContainer,eventListFragment);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_weather) {
            ...
            intent.putExtra("userId",EventListFragment.userId);
            startActivity(intent);
